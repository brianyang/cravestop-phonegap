...
var fatsecret_temp = {
	...
	*/
    ...
    console.log('replace')
      ...
      console.log('responseReplace new instane')
    ...
    console.log('responseReplace()')
      ...
      console.log('doReplace()')
          ...
          //console.log('if qual')
          console.log('find')
          objExists = $(el).children()[3] !== undefined
          //console.log($($(el).children()[3]))
          //console.log(el)
          if(typeof objExists !== 'undefined'){
            console.log('here')
            console.log($('.fatsecret_foodsearch_results>tbody>tr').length)
          }
					//Not a named element. Stick it in the main div.
					if(!el)
						continue;
          console.log(fatsecret.variables.autoTemplate)
